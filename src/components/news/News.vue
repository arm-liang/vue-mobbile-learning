<template>
  <div>
    <ul class="mui-table-view">
        ...
        v-for="(news, idx) in newsList" :key="idx" tag="li">
    ...
    <mt-button type='default' size='large' @click.native="getNewsList">加载更多</mt-button>
  </div>
</template>
...
export default {
  ...
  methods: {
    getNewsList(){
      this.$http.get('getnews?pageIdx=' + this.pageIdx).then(res => {
